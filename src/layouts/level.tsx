import { Layout, Sider, Header, Content, memo, Outlet, Head } from "./rely";
...
// https://img1.baidu.com/it/u=3430690511,3867923153&fm=253&fmt=auto&app=138&f=JPEG?w=500&h=453
const Level = ({items}) => {
    ...
    <Layout className="h-m">
      <Sider collapsed={collapsed} >
        <div className="flex flex-col w-full h-m ">
          <div className=" h-[var(--ant-layout-header-height)]">
            <img
